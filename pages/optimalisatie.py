...
for i in range(len(startpopulatie)):
    st.markdown(startpopulatie[0][i])
    st.markdown(f"f1 {f1(startpopulatie[0][i])}")
    st.markdown(f"f2 {f2(startpopulatie[0][i])}")
    st.markdown(f"f3 {f3(startpopulatie[0][i])}")
    st.markdown(f"f4 {f4(startpopulatie[0][i])}")
    st.markdown(f"f5 {f5(startpopulatie[0][i])}")
