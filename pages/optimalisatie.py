...
def f1(x):
    return (0.6 * x[0] + 0.9 * x[1] + 0.2 * x[2] + 0.7 * x[3] + 0.4 * x[4] + 0.4 * x[5] + 0.6 * x[6] + 0.1 * x[7] + 0.4 * x[8] +
            0.7 * x[9] + 0.9 * x[10] + x[11] + 0.4 * x[12] + 0.2 * x[13] + 0.6 * x[14] + 0.6 * x[15] + 0.2 * x[16] + 0.1 * x[17]
            + 0.5 * x[18] + 0.4 * x[19] + 0.4 * x[20] + 1 * x[21] + 0.2 * x[22] + 0.25 * x[23] + 0.9 * x[24]) 

def f2(x):
    return (0.45 * x[0] + 0.2 * x[1] + 0.6 * x[2] + 0.4 * x[3] + 0.4 * x[4] + 0.5 * x[5] + 1 * x[6] + 0.3 * x[7] + 0.6 * x[8] + 
            0.1 * x[9] + 0.1 * x[10] + 0.1 * x[11] + 0.4 * x[12] + 0.9 * x[13] + 0.75 * x[14] + 0.4 * x[15] + 0.2 * x[16] + 
            0.1 * x[17] + 0.3 * x[18] + 0.4 * x[19] + 0.3 * x[20] + 0.25 * x[21] + 0.4 * x[22] + 0.6 * x[23] + 0.5 * x[24])

def f3(x):
    return (0.95 * x[0] + 0.3 * x[1] + 0.9 * x[2] + 0.45 * x[3] + 0.1 * x[4] + 0.3 * x[5] + 0.9 * x[6] + 0.9 * x[7] + 0.4 * x[8]
            + 0.6 * x[9] + 0.8 * x[10] + 0.2 * x[11] + 0.9 * x[12] + 0.4 * x[13] + 0.6 * x[14] + 0.6 * x[15] + 0.4 * x[16] + 
            0.6 * x[17] + 0.7 * x[18] + 0.4 * x[19] + 0.6 * x[20] + 0.6 * x[21] + 0.8 * x[22] + 0.7 * x[23] + 0.4 * x[24])

def f4(x):
    return (0.8 * x[0] + 0.25 * x[1] + 0.8 * x[2] + 0.5 * x[3] + 0.6 * x[4] + 0.3 * x[5] + 0.8 * x[6] + 0.8 * x[7] + 0.6 * x[8] 
            + 0.7 * x[9] + 0.7 * x[10] + 0.75 * x[11] + 0.8 * x[12] + 0.6 * x[13] + 0.6 * x[14] + 0.4 * x[15] + 0.7 * x[16] + 
            0.7 * x[17] + 0.7 * x[18] + 0.4 * x[19] + 0.4 * x[20] + 0.75 * x[21] + 0.6 * x[22] + 0.5 * x[23] + 0.3 * x[24])

def f5(x):
    return (0.95 * x[0] + 1 * x[1] + 0.4 * x[2] + 0.8 * x[3] + 0.6 * x[4] + 0.7 * x[5] + 0.6 * x[6] + 0.8 * x[7] + 0.65 * x[8] 
            + 0.4 * x[9] + 0.1 * x[10] + 0.5 * x[11] + 0.5 * x[12] + 0.4 * x[13] + 0.8 * x[14] + 0.6 * x[15] + 0.6 * x[16] + 
            0.6 * x[17] + 0.8 * x[18] + 0.3 * x[19] + 0.4 * x[20] + 0.4 * x[21] + 0.2 * x[22] + 0.4 * x[23] + 0.6 * x[24]) 

def f6(x):
    return (0.75 * x[0] + 0.75 * x[1] + 0.8 * x[2] + 0.75 * x[3] + 0.6 * x[4] + 0.75 * x[5] + 0.8 * x[6] + 0.8 * x[7] +
            0.6 * x[8] + 0.7 * x[9] + 0.4 * x[10] + 0.2 * x[11] + 0.5 * x[12] + 0.25 * x[13] + 0.6 * x[14] + 0.3 * x[15] + 
            0.8 * x[16] + 0.8 * x[17] + 0.6 * x[18] + 0.3 * x[19] + 0.4 * x[20] + 0.4 * x[21] + 0.7 * x[22] + 0.5 * x[23] + 
            0.6 * x[24]) 

def f7(x):
    return (0.4 * x[0] + 0.1 * x[1] + 0.4 * x[2] + 0.2 * x[3] + 0.6 * x[4] + 0.3 * x[5] + 0.1 * x[6] + 0.4 * x[7] + 
            0.4 * x[8] + 0.4 * x[9] + 0.2 * x[10] + 0.4 * x[11] + 0.6 * x[12] + 0.25 * x[13] + 0.3 * x[14] + 0.25 * x[15] + 
            0.4 * x[16] + 0.4 * x[17] + 0.4 * x[18] + 0.1 * x[19] + 0.3 * x[20] + 0.4 * x[21] + 0.4 * x[22] + 0.25 * x[23] + 
            0.4 * x[24]) 

def f8(x):
    return (0.4 * x[0] + 0.1 * x[1] + 0.9 * x[2] + 0.8 * x[3] + 0.5 * x[4] + 0.6 * x[5] + 0.9 * x[6] + 0.9 * x[7] + 0.6 * x[8] 
            + 0.4 * x[9] + 0.2 * x[10] + 0.1 * x[11] + 0.1 * x[12] + 0.5 * x[13] + 0.2 * x[14] + 0.2 * x[15] + 0.8 * x[16] + 
            0.6 * x[17] + 0.7 * x[18] + 0.25 * x[19] + 0.4 * x[20] + 0.2 * x[21] + 0.4 * x[22] + 0.7 * x[23] + 0.3 * x[24]) 
